...
class SC_Helper {
     ...
     * @access public
     */
    public function sc_command_exists_check($command) {
     ...
     * @access public
     */
    public function sc_get_full_options() {
        $wpvp_options = array();
     ...
     * @access public
     */
    public function sc_string_limit_words($string, $word_limit) {
        ...
        if ($allow_guest == 'yes') {
            ...
            if (!$user_login) {
                ...
                if (is_array($allowed_user_roles)) {
                    $current_user_role = $this->sc_get_current_user_role();
     ...
     * @access public
     */
    protected function sc_get_current_user_role() {
        global $wp_roles;
     ...
     * @access public
     */
    public function sc_max_upload_size() {
     ...
     * @access public
     */
    public function sc_return_bytes($val) {
        $val = trim($val);
     ...
     * @access public
     */
    public function sc_video_code_add_meta($id) {
